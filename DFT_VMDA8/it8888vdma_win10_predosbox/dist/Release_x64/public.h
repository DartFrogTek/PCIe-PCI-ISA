...
#if defined(_KERNEL_MODE) || defined(_NTDDK_) || defined(_WDMDDK_) || defined(_NTDDK_INCLUDED_) || defined(_WDF_H_)
...
#define IT8888_IOCTL(index, method, access) CTL_CODE(FILE_DEVICE_IT8888VDMA, (index), (method), (access))

#define IOCTL_IT8888_GET_INFO        IT8888_IOCTL(0x800, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_CFG_READ        IT8888_IOCTL(0x801, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_CFG_WRITE       IT8888_IOCTL(0x802, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_PORT_READ       IT8888_IOCTL(0x803, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_PORT_WRITE      IT8888_IOCTL(0x804, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_INIT_DEFAULT    IT8888_IOCTL(0x805, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_DMA_ALLOC       IT8888_IOCTL(0x806, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_DMA_FREE        IT8888_IOCTL(0x807, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_DMA_INFO        IT8888_IOCTL(0x808, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_DEBUG_DUMP      IT8888_IOCTL(0x809, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define IOCTL_IT8888_8237_RESET      IT8888_IOCTL(0x820, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_8237_OUT        IT8888_IOCTL(0x821, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_8237_IN         IT8888_IOCTL(0x822, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_8237_SNAPSHOT   IT8888_IOCTL(0x823, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_8237_PREPARE    IT8888_IOCTL(0x824, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define IOCTL_IT8888_DDMA_ARM        IT8888_IOCTL(0x840, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_DDMA_START      IT8888_IOCTL(0x841, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_DDMA_POLL       IT8888_IOCTL(0x842, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_DDMA_STATUS     IT8888_IOCTL(0x843, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_DDMA_CLEAR      IT8888_IOCTL(0x844, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define IOCTL_IT8888_IRQ_STATUS      IT8888_IOCTL(0x860, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_IRQ_ACK         IT8888_IOCTL(0x861, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_WAIT_IRQ        IT8888_IOCTL(0x862, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define IOCTL_IT8888_TRACE_GET       IT8888_IOCTL(0x880, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_TRACE_CLEAR     IT8888_IOCTL(0x881, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_PANIC_RESET     IT8888_IOCTL(0x882, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_CLEAR_ERRORS    IT8888_IOCTL(0x883, METHOD_BUFFERED, FILE_ANY_ACCESS)

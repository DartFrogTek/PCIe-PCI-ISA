#pragma once
#ifndef IT8888_TRACE_MAX_USER
#define IT8888_TRACE_MAX_USER 256u
#endif
...
#define IOCTL_IT8888_DMA_WRITE \
    IT8888_IOCTL(0x80D, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#define IOCTL_IT8888_PCI_CFGRW \
    IT8888_IOCTL(0x8F1, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_IT8888_BRIDGE_IOWIN \
    IT8888_IOCTL(0x8F2, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#ifndef IT8888_DDMA_FLAG_ALLOW_32BIT
#define IT8888_DDMA_FLAG_ALLOW_32BIT      0x00001000u
#endif
#ifndef IT8888_DDMA_FLAG_NO_READBACK_ARM
#define IT8888_DDMA_FLAG_NO_READBACK_ARM  0x00002000u
#endif
...
#ifndef IT8888_DMA_WRITE_MAX
#define IT8888_DMA_WRITE_MAX 65536
#endif#define IT8888_TRACE_MAX_USER 128
#define IT8888_TRACE_RING_SIZE 512

#pragma pack(push, 1)

typedef struct IT8888_PCI_CFG_RW {
    uint8_t Bus;
    uint8_t Device;
    uint8_t Function;
    uint8_t Offset;
    ...
    uint32_t Bytes;
    uint32_t Status;
} IT8888_PCI_CFG_RW, *PIT8888_PCI_CFG_RW;

typedef struct IT8888_BRIDGE_IOWIN {
    uint8_t Bus;
    uint8_t Device;
    uint8_t Function;
    uint8_t Reserved;
    ...
    uint8_t NewIoBase;
    uint8_t NewIoLimit;
    uint16_t OldIoBaseUpper;
    uint16_t OldIoLimitUpper;
    uint16_t NewIoBaseUpper;
    uint16_t NewIoLimitUpper;
    uint32_t Status;
} IT8888_BRIDGE_IOWIN, *PIT8888_BRIDGE_IOWIN;
...
typedef struct IT8888_DMA_WRITE {
    uint32_t Offset;
    uint32_t Count;
    uint8_t Data[IT8888_DMA_WRITE_MAX];
} IT8888_DMA_WRITE, *PIT8888_DMA_WRITE;

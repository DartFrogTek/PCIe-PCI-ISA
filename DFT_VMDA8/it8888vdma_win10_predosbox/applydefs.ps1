# Run with powershell -ExecutionPolicy Bypass -File .\applydefs.ps1
...
.\dist\Debug_x64\it8888ctl.exe cfgread 0x58 4
.\dist\Debug_x64\it8888ctl.exe cfgread 0x5C 4

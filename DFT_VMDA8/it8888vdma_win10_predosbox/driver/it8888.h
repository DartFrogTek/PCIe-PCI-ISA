...
typedef struct _IT8888_DMA_BUFFER
{
  ...
  SIZE_T Size;
        BOOLEAN LowContiguous; /* MmAllocateContiguousMemorySpecifyCache below 16M */
  ULONG BufferId;
} IT8888_DMA_BUFFER;
...
NTSTATUS It8888PortWrite(PDEVICE_CONTEXT ctx, USHORT port, UCHAR width,
                         ULONG value);
NTSTATUS It8888DmaAllocate(PDEVICE_CONTEXT ctx, ULONG size, ULONG flags, PIT8888_DMA_INFO outInfo);
